...
var digits = lpad(bestShift.toString(), 2);

	document.getElementById("text").value = decrypt(text, bestShift);
	document.getElementById("shift").innerHTML = digits; 
...
var digits2 = lpad(newShift.toString(), 2);
	document.getElementById("shift").innerHTML = digits2;
